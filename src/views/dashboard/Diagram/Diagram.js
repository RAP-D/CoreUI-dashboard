                ...
                onResize={useXarrow()}>
                     <CContainer>
                             ...
                             <CRow className="justify-content-center">
                                ...
                                <Xarrow start={data[0].start} startAnchor= {data[0].startAnchor}  end={data[0].end} endAnchor={data[0].endAnchor} color='#000000' path='grid' dashness={{ animation: 1 }}  showHead={false} strokeWidth={data[0].width} labels={{start:<div style={data[0].style}>{data[0].value.toString()} KWh</div>}}/>
